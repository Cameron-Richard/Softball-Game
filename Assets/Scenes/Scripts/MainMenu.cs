...
public class MainMenu : MonoBehaviour
{
    ...
    {
        StartCoroutine(waitThenLoadLevel5());
    }

    public void PlayLevel6()
    {
        StartCoroutine(waitThenLoadLevel6());
    }

    public void PlayLevel7()
    {
        StartCoroutine(waitThenLoadLevel7());
    }

    public void PlayLevel8()
    {
        StartCoroutine(waitThenLoadLevel8());
    }
    ...
    private IEnumerator waitThenLoadLevel5()
    {
        transition.SetTrigger("Start");
        yield return new WaitForSecondsRealtime(1f);
    ...
    private IEnumerator waitThenLoadLevel6()
    {
        transition.SetTrigger("Start");
        yield return new WaitForSecondsRealtime(1f);
    ...
    private IEnumerator waitThenLoadLevel7()
    {
        transition.SetTrigger("Start");
        yield return new WaitForSecondsRealtime(1f);
    ...
    private IEnumerator waitThenLoadLevel8()
    {
        transition.SetTrigger("Start");
        yield return new WaitForSecondsRealtime(1f);
